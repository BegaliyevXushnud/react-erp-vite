...
import App from '../App';
import { SignIn, SignUp, AdminLayout, Product, Category, Ads, Brands, BrandsCategory, Settings, Stock, Himiko,ProductDetail } from '@pages';
        ...
        <Routes>
          <Route path="/" element={<App />} >
            ...
            <Route path="admin-layout" element={<AdminLayout />} >
              ...
              <Route path="/admin-layout/product/product-detail/:productId" element={<ProductDetail />} />
